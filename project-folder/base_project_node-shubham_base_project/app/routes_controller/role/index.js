...
router.get(
  "/role",
  auditMiddleware({
    moduleName: logEnums.Module.RoleAndRight.name,
    operation: logEnums.Operation.View,
  }),
  auth,
...
router.post(
  ...
  auditMiddleware({
    moduleName: logEnums.Module.RoleAndRight.name,
    operation: logEnums.Operation.Create,
  }),
  auth,
  // authPermission([modules.setup_role_add]),
  validationRules(),
  expressValidate,
  controller.create,
);
...
router.put(
  "/role/:id",
  auth,
  // authPermission([modules.setup_role_edit]),
  validationRules(),
  expressValidate,
  controller.update,
);
...
router.delete(
  "/role/:id",
  auth,
  // authPermission([modules.setup_role_delete]),
  controller.delete,
);
