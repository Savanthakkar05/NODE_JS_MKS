...
const getChangedColumns = (newData, oldData, columns = [], exclude = []) => {
  ...
  columns.forEach((col) => {
    ...
    if (Object.prototype.hasOwnProperty.call(oldData, col))
      oldValue = oldData[col];

    if (Object.prototype.hasOwnProperty.call(newData, col))
      newValue = newData[col];

    if (String(oldValue) !== String(newValue)) {
      // check old and new value for boolean
